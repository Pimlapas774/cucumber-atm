...
public class ATM {
	 ...
	 */
	public void deposit(double value) throws LessThanZeroException {
        if (state == TRANSACT) {
	...
	public void transfer(int customerNum, double amount) throws NotEnoughBalanceException, LessThanZeroException {
        if (state == TRANSACT) {
